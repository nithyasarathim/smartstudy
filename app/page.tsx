          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-xl text-slate-800">StudyGap AI</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 pb-20">
          {!user ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-slate-200 shadow-sm">
              <h2 className="text-2xl font-bold text-slate-700 mb-2">Please Sign In</h2>
              <p className="text-slate-500 mb-6">Log in with Google to access the Syllabus Analyzer</p>
